      ...
      <div className="bg-gradient-to-br from-pink-300 to-blue-300 min-h-screen px-48 py-24">
        <div className=" relative w-full flex flex-col gap-y-12 items-center justify-center px-24 py-12">
          ...
          <div className="px-5 py-2 rounded-md bg-[#4778b1] ">
            ...
            {
            nameMissingError && <span className="text-red-500">Name required</span>
          }
            <div className="px-5 py-2 rounded-md bg-[#4778b1] ">
              <div className="flex items-center gap-5">
                <div className="w-6 h-6 rounded-full overflow-hidden">
          ...
          {/* login Button start*/}
          <div onClick={handleRegistration} style={{
          ...
          <div>
            <span>Already have an account? Please <Link className="text-blue-900 underline" href='/Auth/Login'>Login here</Link></span>
          </div>
        </div>
      </div>
    );
